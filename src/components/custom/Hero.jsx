...
function Hero() {
  return (
    <div className='flex flex-col items-center xl:mx-56 sm:mx-10 md:mx-20 gap-9'>
      <h1 className='font-extrabold xl:text-[50px]  text-center mt-16'>
...
<div><img src="/landing.png" alt="" /></div>
